...
A native module is just an Objective-C class that implements the `RCTBridgeModule` protocol and is instantiated using a plain alloc-init call. If you are wondering, RCT is an abbreviation of ReaCT.
